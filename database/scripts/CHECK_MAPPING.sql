-- =============================================
-- CHECK MAPPING - Kiểm tra mapping đơn giản
-- =============================================
...
PROMPT ========================================
SELECT user_id, username, user_type, reference_id, is_active
FROM SYSTEM_USERS
...
PROMPT ========================================
SELECT su.user_id, su.username, su.reference_id, s.student_id, 
       s.first_name || ' ' || s.last_name AS student_name, s.class_id
...
PROMPT ========================================
SELECT su.user_id, su.username, su.user_type, su.reference_id, 
       l.lecturer_id, l.first_name || ' ' || l.last_name AS lecturer_name, l.department_id
FROM SYSTEM_USERS su
...
PROMPT ========================================
SELECT su.user_id, su.username, su.reference_id, r.relative_id, 
